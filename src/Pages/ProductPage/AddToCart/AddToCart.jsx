...
const AddToCart = ({ id, toast }) => {
  const { getCartQuantity } = useContext(AllDataContext);
    ...
    <div className="addToCart mt-10 flex items-center gap-[10px]">
      <div className="quantity-btn flex font-medium leading-[2.4] border border-[#EEEEEE] rounded-md">
        <div
          ...
          className="increament cursor-pointer px-[16px] flex items-center text-[#212529]"
        >
          <LuPlus></LuPlus>
        </div>
        ...
        <div
          ...
          className="decreament px-[16px] flex items-center text-[#212529]"
        >
          <LuMinus></LuMinus>
        </div>
      </div>
